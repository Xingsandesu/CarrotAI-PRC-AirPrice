...
@mcp.tool(
    name="get_ticket_price_by_date",
    description="查询指定日期的机票价格。该工具用于查询中国主要城市间的实时机票信息，所有城市名称需为中文（如'北京'、'上海'）。返回标准JSON对象：{success: bool, data: object/list, error: string or null}。如调用失败，'error'字段会返回详细信息。"
)
...
@mcp.tool(
    ...
    description="查询区间内所有机票价格。该工具用于查询中国主要城市间的实时机票信息，所有城市名称需为中文（如'北京'、'上海'）。如未提供日期区间，默认查询今天至今天+10天。返回标准JSON对象：{success: bool, data: object/list, error: string or null}。如调用失败，'error'字段会返回详细信息。"
)
...
@mcp.tool(
    name="get_lowest_ticket_price",
    description="查询区间内最低价格机票。该工具用于查询中国主要城市间的实时机票信息，所有城市名称需为中文（如'北京'、'上海'）。如未提供日期区间，默认查询今天至今天+10天。返回标准JSON对象：{success: bool, data: object/list, error: string or null}。如调用失败，'error'字段会返回详细信息。"
)
...
@mcp.tool(
    name="get_round_trip_prices",
    description="查询往返机票价格。该工具用于查询中国主要城市间的实时机票信息，所有城市名称需为中文（如'北京'、'上海'）。如未提供日期区间，默认查询今天至今天+10天。返回标准JSON对象：{success: bool, data: object/list, error: string or null}。如调用失败，'error'字段会返回详细信息。"
)
